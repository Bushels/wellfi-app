...
export default function LoginPage() {
  ...
  const wellCount = useCounter(11764, 2400);
  const operatorCount = useCounter(71, 2000);
      ...
      >
        {CONTOURS.map((contour, index) => (
          <path
            key={index}
            d={contour.d}
            stroke={`rgba(0,212,255,${contour.o})`}
            strokeWidth="1"
            fill="none"
          ...
          <div className="relative z-10 text-center">
            ...
            >
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-gray-800/40 bg-gray-900/20 text-[10px] text-gray-600 font-mono tracking-wide">
                Clearwater + Bluesky · Multi-Operator Access
              </span>
            </div>
          </div>
        </div>
                ...
                >
                  <div className="mb-7">
                    ...
                    <h2 className="text-lg font-syne font-semibold text-white">
                      Basin Intelligence Portal
                    </h2>
                    <p className="text-[13px] text-gray-500 mt-1">
                      Authenticate to access your operator-scoped well map
                    </p>
                  </div>
